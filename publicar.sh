...
# Si el repo ya se renombró a florrincheptine-skech.github.io, apunta el remoto ahí.
if git ls-remote https://github.com/florrincheptine-skech/florrincheptine-skech.github.io.git HEAD >/dev/null 2>&1; then
  git remote set-url origin https://github.com/florrincheptine-skech/florrincheptine-skech.github.io.git
fi
